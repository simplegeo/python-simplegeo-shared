...
PKG='simplegeo-shared'
VERSIONFILE = os.path.join('simplegeo', 'shared', '_version.py')
verstr = "unknown"
try:
...
# rm -rf ./.coverage* htmlcov ; coverage run --branch  --include=simplegeo/* setup.py test -s simplegeo.shared.test ; coverage html
...
setup(name=PKG,
      ...
      license = "MIT License",
      install_requires=['httplib2>=0.6.0', 'oauth2>=1.1.3', 'pyutil'],
      keywords="simplegeo",
